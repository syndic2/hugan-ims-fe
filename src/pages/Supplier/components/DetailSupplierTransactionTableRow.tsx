...
interface DetailSupplierTransactionTableRowProps {
  data: Transaction;
}

const DetailSupplierTransactionTableRow: React.FC<DetailSupplierTransactionTableRowProps> = (props: DetailSupplierTransactionTableRowProps) => {
  const {
    data
  } = props;
...
export default DetailSupplierTransactionTableRow;
