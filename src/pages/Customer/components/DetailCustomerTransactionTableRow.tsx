...
interface DetailCustomerTransactionTableRowProps {
  data: Transaction;
}

const DetailCustomerTransactionTableRow: React.FC<DetailCustomerTransactionTableRowProps> = (props: DetailCustomerTransactionTableRowProps) => {
  const {
    data
  } = props;
...
export default DetailCustomerTransactionTableRow;
